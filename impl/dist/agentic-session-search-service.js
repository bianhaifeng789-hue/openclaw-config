 ...
 * 批量注册会话
 */
export function registerSessions(sessions) {
 ...
 * 基于关键词匹配
 */
export function searchSessionsSimple(query) {
 ...
 * 需要实际调用模型进行语义搜索
 */
export async function searchSessionsAgentic(query) {
    // 简化版：直接使用关键词搜索
    // 完整版需要调用模型进行语义搜索
 ...
 * 创建飞书搜索结果卡片
 */
export function createSearchResultCard(result) {
...
//# sourceMappingURL=agentic-session-search-service.js.map