...
import { createTaskStartCard, createTaskProgressCard, createTaskCompleteCard } from './background-task-card'
...
import { bashCommandClassifier, classifyCommand } from './bash-command-classifier'
...
import { sessionTracing, startSessionTrace, recordToolCall } from './session-tracing'

// Phase 6: Hooks
import { hooksSystem, canUseTool, setStatus, matchTypeahead } from './hooks-system'

// Phase 7: Swarm
import { swarmService, detectBackends, createTeammate } from './swarm-service'
