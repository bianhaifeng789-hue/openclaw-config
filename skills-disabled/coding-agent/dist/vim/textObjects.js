 ...
 */
export function findTextObject(text, offset, obj, scope) {
    switch (obj) {
        case 'w':
 ...
 */
function findWord(text, offset, scope) {
 ...
 */
function findQuotes(text, offset, quote, scope) {
    // Find opening quote
    let openQuote = -1;
 ...
 */
function findBrackets(text, offset, openBracket, closeBracket, scope) {
