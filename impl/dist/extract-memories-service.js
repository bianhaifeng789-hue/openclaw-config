 ...
 * 从会话历史提取记忆
 */
export function extractFromSession(messages) {
    const extracted = [];
 ...
 * 从文本提取特定类型记忆
 */
export function extractByType(text, type) {
    const patterns = {
 ...
 * 获取最近记忆
 */
export function getRecentMemories(hours = 24) {
 ...
 * 生成飞书记忆卡片
 */
export function generateMemoryCard() {
    const byType = {
        decision: 0,
        preference: 0,
        progress: 0,
...
//# sourceMappingURL=extract-memories-service.js.map