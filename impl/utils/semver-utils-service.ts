...
/**
 * Semver Utils Pattern - Semver工具
 * 
 * Source: Claude Code utils/semver.ts
 * Pattern: semver utils + version comparison + version handling + semantic versioning
 */
...
class SemverUtilsService {
  private comparisons: Array<{ a: string; b: string; result: number }> = []

  /**
   * Parse version
   */
  parse(version: string): SemverInfo | null {
   ...
   * Get comparisons
   */
  getComparisons(): Array<{ a: string; b: string; result: number }> {
