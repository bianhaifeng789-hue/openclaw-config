...
export class SmartHeartbeatScheduler {
    ...
    check() {
        ...
        pending.sort((a, b) => {
            ...
            if (a.name === 'health-monitor' && pending.length > 1)
                return 1;
            if (b.name === 'health-monitor' && pending.length > 1)
                return -1;
...
//# sourceMappingURL=smart-heartbeat-scheduler.js.map