 ...
 */
export function setAutoModeFlagCli(flag: boolean): void {
 ...
 */
export function setAutoModeOptInRequired(required: boolean): void {
 ...
 */
export function isAutoModeOptInRequired(): boolean {
 ...
 */
export function _resetAutoModeStateForTesting(): void {
 ...
 */
export function shouldAutoModeApply(): boolean {
 ...
 */
export function tryEnableAutoMode(): boolean {
