...
import { forkedAgentCache, saveCacheSafeParams, getLastCacheSafeParams, createCacheSafeParams, runForkedAgent, createSubagentContext, } from './forked-agent-cache';
export { forkedAgentCache, saveCacheSafeParams, getLastCacheSafeParams, createCacheSafeParams, runForkedAgent, createSubagentContext, };
// Background Task Utils - 先导入再导出
import { registerTask, updateProgress, completeTask, failTask, getRunningTasks, createTaskCard, createTasksSummaryCard, checkActiveTasks, backgroundTaskService, } from './background-task-utils';
export { registerTask, updateProgress, completeTask, failTask, getRunningTasks, createTaskCard, createTasksSummaryCard, checkActiveTasks, backgroundTaskService, };
export async function runBackgroundTaskWithCache(options) {
...
// ============================================
export function createMemoryMaintenanceFork() {
    return {
...
export function createInsightsAnalysisFork() {
    return {
...
export function createAutoDreamFork() {
    return {
        taskName: 'AutoDream',
...
//# sourceMappingURL=forked-agent-utils.js.map