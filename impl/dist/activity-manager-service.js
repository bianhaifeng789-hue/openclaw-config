 ...
 * 记录活跃事件
 */
export function recordActivity(sessionId, channelId) {
    const now = Date.now();
    // 如果之前是空闲/离开，记录回来事件
 ...
 * 获取最近活跃时段
 */
export function getRecentActivePeriods(hours = 24) {
 ...
 * Heartbeat 检查点
 */
export async function checkActivityForHeartbeat() {
...
//# sourceMappingURL=activity-manager-service.js.map