...
async function saveHeartbeatState(state) {
    await fs.writeFile(path.join(MEMORY_DIR, 'heartbeat-state.json'), JSON.stringify(state, null, 2), 'utf-8');
}
async function loadDreamState() {
    try {
...
// Task Checkers
// ============================================================================
function shouldRunTask(task, state) {
...
// Task Executors
// ============================================================================
async function executeTaskVisualizer(state) {
...
async function executeMemoryCompact(state) {
...
async function executeMemoryMaintenance(state) {
...
async function executeAutoDream(state) {
...
// 新接入的 5 个服务执行函数
// ============================================================================
async function executeBuddyCompanion(state) {
    try {
...
async function executeAwaySummary(state) {
    try {
...
async function executeSideQueryStats(state) {
    try {
...
async function executeArgumentStats(state) {
    try {
...
async function executeMailboxCheck(state) {
    try {
...
// 新增服务执行函数 (2026-04-13)
// ============================================================================
async function executeDiagnosticTracking(state) {
    try {
...
async function executeInternalLogging(state) {
    try {
...
async function executeRateLimitCheck(state) {
    try {
...
async function executeMcpApprovalPoll(state) {
    try {
...
async function executeExtractMemories(state) {
    try {
...
async function executeToolUseSummary(state) {
    try {
...
// Main Executor
// ============================================================================
export async function runHeartbeatExecutor() {
...
// ============================================================================
export async function quickHeartbeatCheck() {
    const state = await loadHeartbeatState();
    const tasks = checkAllTasks(state);
